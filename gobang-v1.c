...
#define WIN5 500000
#define LIVE4 100000//活四011110
#define JUMP4ss 60000 //跳冲四且堵后仍可形成冲三，即#1011100，且能冲四
#define JUMP4s 53000 //跳冲四且堵后仍可形成冲三，即#101110#。但不能冲四
#define JUMP4bss 52000 //1101100
#define JUMP4bs 51500 //110110
#define HALF4 51000 //冲四
#define LIVE3 50000 //活三，能形成两个活四
#define HALFLIVE3 40000 //半活半冲三：一点可以形成活四，另一点只能形成冲四
#define HALFHALFLIVE3 30000 //双冲三，两个点可以形成冲四
#define JUMP3bbsss 30500 //10011000跳三，中间空两格，且另一侧三个空位，两个点冲四
#define JUMP3bbss 30000 //1001100跳三，中间空两格，且另一侧2个空位，两个点冲四
#define JUMP3bss 29000 //101100跳三，中间空一格，另一侧空两格，？点冲四，可形成101101
#define JUMP3bbs 27500 //100110跳三，中间空两格，且另一侧1个空位，两个点冲四
#define JUMP3bs 24000 //10110

#define HALF3 20000 //只能形成一个冲四的三
...
int score(int i,int j,char code[],int color){
	...
	if(color==BLACK){
		...
		}else if(strindex(code,"111")>=2 && strindex(code,"111")<=4){
		...
		}else if(strindex(code,"11")>=3 && strindex(code,"11")<=4){
